    ...
    try {
      ...
      if (response.ok) {
        ...
        if (user) {
          useAuthStore
            .getState()
            .setAuth(user, accessToken, currentRefreshToken!);
        }
        return accessToken;
      }
      return null;
...
//UoM API
export const uomApi = {
  getUOMs: (params?: { page?: number; limit?: number; search?: string }) =>
    api.get(
      `/inventory/uoms${
        params ? "?" + new URLSearchParams(params as any).toString() : ""
      }`,
  ...
  deleteUOM: (id: string) => api.delete(`/inventory/uoms/${id}`),
};
...
export const productionApi = {
  ...
  printProductionOrder: (id: string) =>
  ...
  addLabor: (id: string, data: any) =>
    api.post(`/production/orders/${id}/add-labor`, data),
  addOverhead: (id: string, data: any) =>
    api.post(`/production/orders/${id}/add-overhead`, data),
  receiveFinishedGoods: (id: string, data: any) =>
    api.post(`/production/orders/${id}/receive-fg`, data),
  finishProductionOrder: (id: string) =>
    api.post(`/production/orders/${id}/finish`),
...
export const salesApi = {
  ...
  deliverSale: (id: string, data: any) =>
    api.post(`/sales/orders/${id}/deliver`, data),
  ...
  updateCustomerGroup: (id: string, data: any) =>
    api.put(`/sales/customer-groups/${id}`, data),
};
...
export const cashApi = {
  ...
  updateCashAccount: (id: string, data: any) =>
    api.put(`/cash/accounts/${id}`, data),
  ...
  approveCashTransaction: (id: string) =>
    api.post(`/cash/transactions/${id}/approve`),
  authorizeCashTransaction: (id: string) =>
    api.post(`/cash/transactions/${id}/authorize`),
  ...
  updateCashTransaction: (id: string, data: any) =>
    api.put(`/cash/transactions/${id}/update`, data),
  ...
  createCustomerPayment: (data: any) =>
    api.post("/cash/customer-payments", data),
  getCustomerPayments: (params?: any) =>
    api.get(
  ...
  approveCustomerPayment: (id: string) =>
    api.post(`/cash/customer-payments/${id}/approve`),
  authorizeCustomerPayment: (id: string) =>
    api.post(`/cash/customer-payments/${id}/authorize`),
  payCustomerPayment: (id: string) =>
    api.post(`/cash/customer-payments/${id}/pay`),
  deleteCustomerPayment: (id: string) =>
    api.delete(`/cash/customer-payments/${id}`),
  updateCustomerPayment: (id: string, data: any) =>
    api.put(`/cash/customer-payments/${id}/update`, data),
  printCustomerPayment: (id: string) =>
    api.get(`/cash/customer-payments/${id}/print`),
  ...
  approveVendorPayment: (id: string) =>
    api.post(`/cash/vendor-payments/${id}/approve`),
  authorizeVendorPayment: (id: string) =>
    api.post(`/cash/vendor-payments/${id}/authorize`),
  payVendorPayment: (id: string) => api.post(`/cash/vendor-payments/${id}/pay`),
  deleteVendorPayment: (id: string) =>
    api.delete(`/cash/vendor-payments/${id}`),
  printVendorPayment: (id: string) =>
    api.get(`/cash/vendor-payments/${id}/print`),
  updateVendorPayment: (id: string, data: any) =>
    api.put(`/cash/vendor-payments/${id}/update`, data),
  createVendorRefund: (data: any) => api.post("/cash/vendor-refunds", data),
  getVendorRefunds: (params?: any) =>
    api.get(
      `/cash/vendor-refunds${
        params ? "?" + new URLSearchParams(params).toString() : ""
      }`,
  ...
  createPurchasePayment: (data: any) =>
    api.post("/cash/purchase-payments", data),

  getCustomerRefunds: (params?: any) =>
    api.get(
...
export const managementApi = {
  ...
  createChartAccount: (data: any) =>
    api.post("/management/chart-of-accounts", data),
  updateChartAccount: (id: string, data: any) =>
    api.put(`/management/chart-of-accounts/${id}`, data),
  deleteChartAccount: (id: string) =>
    api.delete(`/management/chart-of-accounts/${id}`),

  // Cash Account Management
  getCashAccountsManagement: () => api.get("/management/cash-accounts"),
  createCashAccountManagement: (data: any) =>
    api.post("/management/cash-accounts", data),
  updateCashAccountManagement: (id: string, data: any) =>
    api.put(`/management/cash-accounts/${id}`, data),
  deleteCashAccountManagement: (id: string) =>
    api.delete(`/management/cash-accounts/${id}`),
...
export const assetsApi = {
  ...
  disposeAsset: (assetId: string, data: any) =>
    api.post(`/assets/${assetId}/dispose`, data),
...
export const posApi = {
  // Sessions
  createSession: (data: CreatePosSessionRequest) =>
    api.post("/pos/sessions", data),
  closeSession: (sessionId: string, data: { closingBalance: number }) =>
    api.patch(`/pos/sessions/${sessionId}/close`, data),
  ...
  // Returns
  createReturn: (data: CreatePosReturnRequest) =>
...
export const memoApi = {
  ...
  getMemoById: (id: string) => api.get(`/memos/${id}`),
  ...
  deleteMemo: (id: string) => api.delete(`/memos/${id}`),
};
