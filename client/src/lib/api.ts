...
export const userApi = {
  ...
  createUser: (data: { name: string; email: string; password: string; roleId: string; warehouseId?: string }) =>
...
export const cashApi = {
  ...
  getCustomerPayments: (params?: any) => api.get(`/cash/customer-payments${params ? '?' + new URLSearchParams(params).toString() : ''}`),
  getCustomerPayment: (id?: string) => api.get(`/cash/customer-payments${id}`),
  approveCustomerPayment: (id: string) => api.post(`/cash/customer-payments/${id}/approve`),
  authorizeCustomerPayment: (id: string) => api.post(`/cash/customer-payments/${id}/authorize`),
...
export const posApi = {
  // Sessions
  createSession: (data: CreatePosSessionRequest) => api.post('/pos/sessions', data),
  ...
  getSales: (params?: { page?: number; limit?: number; sessionId?: string; customerId?: string; dateFrom?: string; dateTo?: string }) =>
    api.get(`/pos/sales${params ? '?' + new URLSearchParams(params as any).toString() : ''}`),
