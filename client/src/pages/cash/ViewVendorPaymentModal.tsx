        ...
        <div className="inline-block bg-white rounded-lg shadow-xl transform transition-all sm:max-w-5xl sm:w-full sm:my-8">
          <div className="bg-white p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-medium text-gray-900">View Vendor Payment</h3>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <input disabled {...register('paymentDate')} type="date" className="mt-1 w-full border rounded-md px-3 py-2" />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <select  disabled {...register('cashAccountId')} className="mt-1 w-full border rounded-md px-3 py-2">
                ...
                <div>
                  ...
                  <input disabled {...register('reference')} className="mt-1 w-full border rounded-md px-3 py-2" />
                </div>
              </div>
                    ...
                    <div key={field.id} className="bg-gray-50 p-4 rounded-lg">
                      <div className="grid grid-cols-1 sm:grid-cols-8 gap-4">
                        ...
                        <div className="col-span-2">
                          ...
                          <select disabled {...register(`lines.${index}.purchaseId`)} className="mt-1 w-full border rounded-md px-3 py-2" >
                        ...
                        <div className="col-span-2">
                          ...
                          <input disabled {...register(`lines.${index}.description`)} className="mt-1 w-full border rounded-md px-3 py-2" />
                        </div>
