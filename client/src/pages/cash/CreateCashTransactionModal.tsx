              ...
              <div>
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button
                    ...
                    onClick={() => append({ glAccountId: '', lineAmount: 0, description: '' })}
                ...
                {errors.transactionLines && (
                  <p className="mb-4 text-sm text-red-600">{errors.transactionLines.message}</p>
                )}
                ...
                <label className="block text-sm font-medium text-gray-700">
                 ...
                 <ChartAccountSelect
                    ...
                    onChange={(val) => setValue(`transactionLines.${index}.glAccountId`, val)}
                        // error={errors.accountId?.message}
                />
                
                {errors.transactionLines?.[index]?.glAccountId && (
                  <p className="mt-1 text-sm text-red-600">
                    {errors.transactionLines[index]?.glAccountId?.message}
                  </p>
                )}
                ...
                <div>
                  ...
                  <input
                    {...register(`transactionLines.${index}.lineAmount`, { valueAsNumber: true })}
                    type="number"
                    step="0.001"
                    className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                    placeholder="1.00"
                  ...
                  {errors.transactionLines?.[index]?.lineAmount && (
                    <p className="mt-1 text-sm text-red-600">
                      {errors.transactionLines[index]?.lineAmount?.message}
                    </p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {errors.transactionLines?.[index]?.description && (
                    <p className="mt-1 text-sm text-red-600">
                      {errors.transactionLines[index]?.description?.message}
                    </p>
                  )}
