...
import { reportsApi, inventoryApi, salesApi, purchaseApi, productionApi, managementApi } from '../lib/api';
  ...
  userId: usersFilter,
        ...
        case 'customer-ledger':
          ...
          data = await reportsApi.getCustomerLedger({
            dateFrom,dateTo, customerId: customerId});
        break;
        case 'vendor-ledger':
    ...
    try {
      switch (selectedReport) {
        ...
        case 'pos-sales':
          ...
          ReportExporter.exportGenericReport(reportData, POSsalesColumns, 'POS Sales Details', format);
          break; }
        case 'sales-by-customer':
  ...
  return (
    <div className="space-y-4">
      <div className="text-center">
        ...
        <p className="text-gray-600">
         Detail of POS Sales for all terminals
        </p>
      </div>
