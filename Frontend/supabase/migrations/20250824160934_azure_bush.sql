/*
  ...
  2. Changes
    - Add `locationId` column to `warehouses` table as nullable first
    - Create default locations
    - Update existing warehouses to reference default locations
    - Make `locationId` NOT NULL after data migration
...
-- Add locationId column as nullable first
DO $$
BEGIN
  IF NOT EXISTS (
...
-- Now make locationId NOT NULL since all rows have values
