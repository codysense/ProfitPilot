...
const management_1 = require("../types/management");
const management_2 = require("../services/management");
...
class ManagementController {
    ...
    async getAuditLogs(req, res) {
        try {
            ...
            if (entity)
                where.entity = String(entity).toUpperCase();
            if (dateFrom || dateTo) {
                where.createdAt = {};
                if (dateFrom)
    ...
    async updateCompanySettings(req, res) {
        try {
            const validatedData = management_1.updateCompanySettingsSchema.parse(req.body);
    ...
    async getSystemSettings(req, res) {
        try {
            ...
            const settings = await managementService.getSystemSettings(category);
            res.json({ settings });
        }
        catch (error) {
    ...
    async updateSystemSetting(req, res) {
        try {
            const validatedData = management_1.updateSystemSettingSchema.parse(req.body);
    ...
    async getCostingPolicy(req, res) {
        try {
    ...
    async updateCostingPolicy(req, res) {
        try {
    ...
    async createFiscalYear(req, res) {
        try {
            const validatedData = management_1.createFiscalYearSchema.parse(req.body);
    ...
    async getFiscalPeriods(req, res) {
        try {
            const { fiscalYearId } = req.query;
            const periods = await managementService.getFiscalPeriods(fiscalYearId);
            res.json({ periods });
        }
        catch (error) {
    ...
    async activateFiscalPeriod(req, res) {
        try {
            const { id } = req.params;
    ...
    async closeFiscalPeriod(req, res) {
        try {
            const { id } = req.params;
    ...
    async createApprovalWorkflow(req, res) {
        try {
            const validatedData = management_1.createApprovalWorkflowSchema.parse(req.body);
    ...
    async getApprovalRequests(req, res) {
        try {
            ...
            const requests = await managementService.getApprovalRequests(userId, status);
            res.json({ requests });
        }
        catch (error) {
    ...
    async processApprovalAction(req, res) {
        try {
            const { id } = req.params;
            const { action, comments } = management_1.approvalActionSchema.parse(req.body);
            const result = await managementService.processApprovalAction(id, action, req.user.id, comments);
    ...
    async createRole(req, res) {
        try {
            const validatedData = management_1.createRoleSchema.parse(req.body);
    ...
    async updateRole(req, res) {
        try {
            const { id } = req.params;
            const validatedData = management_1.updateRoleSchema.parse(req.body);
    ...
    async getUsersWithDetails(req, res) {
        try {
            const { page = 1, limit = 10, search } = req.query;
            const result = await managementService.getUsersWithDetails(Number(page), Number(limit), search);
            res.json(result);
        }
        catch (error) {
    ...
    async createChartAccount(req, res) {
        try {
            const validatedData = management_1.createChartAccountSchema.parse(req.body);
    ...
    async updateChartAccount(req, res) {
        try {
            const { id } = req.params;
    ...
    async deleteChartAccount(req, res) {
        try {
            const { id } = req.params;
